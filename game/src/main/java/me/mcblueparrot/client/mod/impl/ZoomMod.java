...
public class ZoomMod extends Mod implements PrimaryIntegerSettingMod {
	...
	private KeyBinding key = new KeyBinding("Zoom", Keyboard.KEY_C, "Ember Client");
	@ConfigOption("Zoom Out")
	private KeyBinding zoomOutKey = new KeyBinding("Zoom Out", Keyboard.KEY_MINUS, "Ember Client");
	@ConfigOption("Zoom In")
	private KeyBinding zoomInKey = new KeyBinding("Zoom In", Keyboard.KEY_EQUALS, "Ember Client");
