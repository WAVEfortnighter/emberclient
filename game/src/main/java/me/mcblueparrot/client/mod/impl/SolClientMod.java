...
public class SolClientMod extends ConfigOnlyMod {
	...
	public KeyBinding modsKey = new KeyBinding("Mods", Keyboard.KEY_RSHIFT, "Ember Client");

	@ConfigOption("Edit HUD Key")
	public KeyBinding editHudKey = new KeyBinding("Edit HUD", Keyboard.KEY_GRAVE, "Ember Client");
	...
	public SolClientMod() {
		super("Ember Client", "sol_client", "Settings Menu for Ember Client.", ModCategory.GENERAL);
		instance = this;
